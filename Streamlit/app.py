...
st.markdown("<h3 style='text-align: center; color: black;'>My Heart Will Go On - Céline Dion</h3>", unsafe_allow_html=True)
st.audio('My Heart Will Go On - Céline Dion.mp3')
st.markdown("<h2 style='text-align: center; color: black;'>Модель машинного обучения для предсказания исхода поездки на лайнере 'Титаник'</h2>", unsafe_allow_html=True)
...
name = st.text_input('Имя', 'Jane Doe')
