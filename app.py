...
st.markdown("<h1 style='text-align: center; color: black;'>"Рассказанная Немногими Выжившими История..."\n</h1>", unsafe_allow_html=True)
st.audio('My Heart Will Go On - Céline Dion.mp3', caption = 'My Heart Will Go On - Céline Dion')
st.markdown("<h2 style='text-align: center; color: black;'>"Модель машинного обучения для предсказания исхода поездки на лайнере "Титаник""\n</h2>", unsafe_allow_html=True)
